...
- [x] Field note: `weather-claims-and-the-record` — date 2024-09-25, category Risk, 6 min. How preserved capture supports a weather claim.  ✓ 2026-04-27
...
- [x] Field note: `digital-construction-lead-view-of-rdi` — date 2025-12-24, category Roles, 6 min. The digital lead's stack view.  ✓ 2026-04-27
- [x] Field note: `mission-critical-projects-and-rdi` — date 2026-01-07, category Industry, 7 min. Why data centres and similar projects need command-grade evidence.  ✓ 2026-04-27
- [x] Field note: `infrastructure-projects-and-rdi` — date 2026-01-21, category Industry, 6 min. Linear projects, distributed risk, evidence chains.  ✓ 2026-04-27
- [x] Field note: `commercial-buildings-and-rdi` — date 2026-02-04, category Industry, 5 min. The bread-and-butter project type for RDI.  ✓ 2026-04-27
...
- [x] Field note: `the-economics-of-doing-nothing` — date 2026-04-15, category Economics, 6 min. The implicit cost of staying with manual evidence handling.  ✓ 2026-04-27
...
- [x] KB article: `learning-path-practitioner` — area learning-paths, 6 min. Practitioner curriculum overview.  ✓ 2026-04-28
...
- [x] KB article: `quote-brief-walkthrough` — area planning-tools, 5 min. How to use the project brief for a quote.  ✓ 2026-04-28
...
- [x] Course lesson: in `claims-evidence-practitioner`, add `payment-evidence-and-cycles` — 13 min, 3 sections, checkpoint.  ✓ 2026-04-28
- [x] Course lesson: in `claims-evidence-practitioner`, add `building-the-claim-file` — 14 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `safety-workflows-site-leadership`, add `from-finding-to-closeout` — 12 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `safety-workflows-site-leadership`, add `regulatory-and-insurer-conversations` — 14 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `rdi-for-owners`, add `the-owners-question` — 10 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `rdi-for-owners`, add `portfolio-command-for-owners` — 11 min, 3 sections, checkpoint.  ✓ 2026-04-28

### Course 4: Capture Planning and Coverage

- [x] Course shell: `capture-planning-and-coverage` — title "Capture Planning and Coverage", level Practitioner, estimatedMinutes 75, outcomes and audience filled, `lessons: []`. Audience: digital construction leads, planners, project directors.  ✓ 2026-04-28
- [x] Course lesson: in `capture-planning-and-coverage`, add `from-camera-count-to-capture-plan` — 12 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `capture-planning-and-coverage`, add `handover-of-the-capture-plan` — 13 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `rdi-economics-business-case`, add `tracking-outcomes-after-go-live` — 13 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Course lesson: in `rdi-foundations`, add `category-boundary-in-practice` — 12 min, 3 sections (vs cameras, vs dashboards, vs BIM), checkpoint.  ✓ 2026-04-28
- [x] Course lesson: in `rdi-foundations`, add `command-views-and-portfolio-thinking` — 12 min, 3 sections, checkpoint.  ✓ 2026-04-28
...
- [x] Case study: `commercial-fitout-design-verification` — sector "Commercial fitout", primary packs design-verification and stakeholder-reporting.  ✓ 2026-04-28
- [x] Case study: `energy-project-gate-and-logistics` — sector "Energy", primary packs gate-logistics and safety-monitoring.  ✓ 2026-04-28
- [x] Case study: `industrial-subcontractor-performance` — sector "Industrial", primary packs subcontractor-performance and progress-verification.  ✓ 2026-04-28
