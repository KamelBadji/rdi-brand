          ...
          <div className="grid gap-5 lg:grid-cols-[minmax(0,0.42fr)_minmax(0,0.58fr)]">
            <div className="border border-border bg-white p-6">
              ...
              <p className="mt-4 text-sm leading-[1.7] text-rdi-muted">
                {costModel.template.description}
              </p>
            </div>
            <div className="border border-border bg-rdi-paper p-6">
              ...
              <p className="mt-3 font-mono text-sm leading-7 text-rdi-ink">
                {costModel.template.formula}
              </p>
            </div>
          </div>
        ) : (
          <div className="border border-border bg-white p-6">
            <h3 className="text-lg font-semibold text-rdi-ink">Qualitative workflow</h3>
            <p className="mt-3 text-sm leading-[1.7] text-rdi-muted">
              This workflow is currently represented as a qualitative benefit. A parametric cost
              model should be added only when the assumption set is credible.
            </p>
          </div>
        )}
      </Section>
